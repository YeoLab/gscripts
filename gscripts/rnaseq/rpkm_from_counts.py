...
if __name__ == '__main__':
    cl = CommandLine()
    try:
        job_name = '_'.join([cl.args['name'], 'rpkm_from_counts'])
        ...
        RPKMfromCounts(job_name, out_sh, submit, directory)
