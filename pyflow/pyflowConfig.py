...
class DefaultSiteConfig(object) :
   ...
   # 
    ...
    def _qsubResourceArgConfig(cls, nCores, memMb) :
        ...
        #
        class Constants(object) : megsPerCore = 8192
...
class TSCCConfig(DefaultSiteConfig) :
    """
    specializations for TSCC at UCSD
    """
